...
<#assign header = "Current Appointments & Affiliations">
<#if positions?has_content> <#-- true when the property is in the list, even if not populated (when editing) -->
    <#assign localName = positions.localName>
    <h2 id="${localName}" class="mainPropGroup" title="">${header}<@p.addLink positions editable /> <@p.verboseDisplay positions /></h2>
